...
def fa3_transform_bwd(
    ...
    *, 
    ...
    dq, dk, dv = grads
    put_grads((q, k, v,), (dq, dk, dv,))
    return out

fa3_ex.register_implementation(thunder.torch.scaled_dot_product_attention, checker=fa3_checker,
                                execution_transform=fa3_transform, grad_transform=fa3_transform_bwd)
