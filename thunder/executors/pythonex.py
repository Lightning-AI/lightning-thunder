...
py_max = ex.register_operator("max", like=prims.py_max, module=builtins)
py_min = ex.register_operator("min", like=prims.py_min, module=builtins)
...
ex.register_implementation(prims.py_max, py_max, checker=_elementwise_binary_checker)
ex.register_implementation(prims.py_min, py_min, checker=_elementwise_binary_checker)
