# Taken from: https://github.com/pytorch/pytorch/blob/master/torch/utils/_pytree.py
...
def map_only(ty: TypeAny) -> MapOnlyFn[FnAny[Any]]:
    """Suppose you are writing a tree_map over tensors, leaving everything else unchanged.  Ordinarily you would have to
    write:
