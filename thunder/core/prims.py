    ...
    def meta(a: Number | TensorProxy, /) -> Number | TensorProxy:
        ...
        if isinstance(a, Number):
            ...
            if val is None or number_fn is None:
                utils.check(isinstance(a, NumberProxy), lambda: f"Trying to call an elementwise unary operation {name} on a number, but the operation is not eagerly defined")
    ...
    def meta(
        ...
        if isinstance(a, Number) and isinstance(b, Number):
            ...
            if aval is None or bval is None or number_fn is None:
                utils.check(isinstance(a, NumberProxy) or isinstance(b, NumberProxy), lambda: f"Trying to call an elementwise binary operation {name} on two numbers, but the operation is not eagerly defined")
