...
def snippet_torch_consistency(op: OpInfo, torch_op, sample: SampleInput, comp: Callable):
    ...
    # No need for testing accuracy of non-floating types
    if not isinstance(torch_result, torch.Tensor) or not torch.is_floating_point(torch_result):
    ...
    assert_closer(
        ...
        candidate=(thunder_result,),
        competitor=(torch_result,),
        comparator=comp,
    )
