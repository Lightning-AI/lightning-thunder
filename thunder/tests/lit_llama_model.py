"""
Lit-llama's model.py taken from https://github.com/Lightning-AI/lit-llama.
...
def build_rope_cache(
    ...
    cache = torch.polar(torch.ones_like(idx_theta).to(working_dtype), idx_theta.to(working_dtype)).to(complex_dtype)
    return cache
