...
@torchsymbol(
    "grad_forward_scaled_dot_product_flash_attention",
    id="grad_forward_scaled_dot_product_flash_attention",
    is_prim=True,
)
def grad_forward_scaled_dot_product_flash_attention(
    query: TensorLike,
    key: TensorLike,
    value: TensorLike,
    dropout_p: float = 0.0,
...
@torchsymbol(
    ...
    id="scaled_dot_product_flash_attention_backward",
    is_prim=True,
)
