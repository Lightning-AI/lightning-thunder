...
3. Adds them to the LLM prompt as "REFERENCE DOCUMENTATION"
4. LLM analyzes the PR using these documents to calibrate its assessment
...
analyze_single_pr(
    pr_number=YOUR_PR,
    gdrive_files=["YOUR_FILE_1", "YOUR_FILE_2"]
)
